...
//     // ✅ local state fixes password toggle re-render issues
...
//     const inputClasses = clsx(
//         "h-10 w-full rounded-xl border px-4 py-2 text-sm appearance-none",
//         "bg-white/5 text-white placeholder:text-neutral-400",
//         "focus:outline-none focus:ring-2",
//         {
//             "cursor-not-allowed opacity-60 border-neutral-700": disabled,
//             "border-red-500 focus:ring-red-500/20": errorMessage,
//             "border-success-400 text-success-400 focus:ring-success-500/20":
//                 success && !errorMessage,
//             "border-neutral-700 focus:border-brand-500 focus:ring-brand-500/20":
//                 !disabled && !errorMessage && !success,
//         },
...
//                         tabIndex={-1}
//                         onClick={() => setShowPassword((p) => !p)}
//                         className="absolute right-3 top-1/2 z-10 -translate-y-1/2 text-neutral-400 hover:text-white"
//                     >
//                         <Icon name={showPassword ? "EyeOff" : "Eye"} size={18} />
//                     </button>
//                 )}
...
//             "border-red-500 focus:ring-red-500/10": errorMessage,

//             "border-success-400 text-success-400 focus:ring-success-500/10":
//                 success && !errorMessage,

//             "border-neutral-700 focus:border-brand-500 focus:ring-brand-500/10":
//                 !disabled && !errorMessage && !success,
//         },
//         isPassword && "pr-12",
//         className
